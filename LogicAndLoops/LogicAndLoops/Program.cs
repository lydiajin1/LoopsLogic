namespace LogicAndLoops
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //Go to the left
                Console.WriteLine("You take the path to the left. It leads you out of the jungle. Don't worry you'll be back soon...");

            }
            else if (userChoice == "right")
            {
                //Go to the right
                Console.WriteLine("You take the path to the right. It leads you into a cave. HA! you are trapped!");
            }
            else
            {
                ...
                {
                    //Easter Egg
                    Console.WriteLine("'up' seriously? 'up'!? How can we go up? **Flips keyboard** CLOSE THE PROGRAM!");
                }
                else
                {
